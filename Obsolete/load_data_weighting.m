function [data] = load_data_weighting(subjectDir, sessionList)
...
%
%           NB. simultaneous extraction of different weight task type(ie. RE & PE) is not possible with this function,
%           you need to specify sessionList of a same weight task type
%
% OUT
...
[fileList, nSessions] = tools.load_file(subjectDir, MANIP_NAME, sessionList);
...
for nsess = 1:nSessions
    data.condition.sessionNumber =   horzcat( data.condition.sessionNumber , nsess*ones(1,size(fileList(1, 1).data,1 )) ) ;
end
